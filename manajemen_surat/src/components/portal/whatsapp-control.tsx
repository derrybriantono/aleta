...
export function WhatsAppControl() {
  ...
  const phonePolicy = snapshot.requiresPhoneNumberBeforeInit
    ...
    : "Nomor resmi bisa diisi setelah WhatsApp disiapkan.";
        ...
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div className="flex items-start gap-3">
            ...
            <div className="space-y-1">
              <CardTitle>Ringkasan WhatsApp</CardTitle>
              <CardDescription>
                Koneksi WhatsApp kantor diatur dari satu halaman agar tidak membingungkan.
              </CardDescription>
            </div>
          </div>
      ...
      <CardContent className="space-y-5 pt-6">
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          ...
          <SummaryItem
            ...
            description="Nama yang dipakai sistem untuk koneksi WhatsApp."
          />
          <SummaryItem
        ...
        <div className="rounded-[1.2rem] border border-dashed border-border bg-muted/35 p-4">
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div className="space-y-2">
              <p className="text-sm font-semibold text-foreground">QR dibuka dari halaman WhatsApp</p>
              <p className="text-sm leading-6 text-muted-foreground">
                Jika status <strong className="text-foreground">Perlu Pindai QR</strong>, buka halaman status WhatsApp untuk memindai QR dan menyambungkan ulang.
              </p>
            </div>
