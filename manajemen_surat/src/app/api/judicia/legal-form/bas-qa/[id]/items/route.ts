...
import { addBasQaItem } from "@/server/modules/judicia/legal-form/bas-qa/jlf-bas-qa-service";
...
export async function POST(request: NextRequest, context: { params: Promise<{ id: string }> }) {
  try {
    ...
    return created(await addBasQaItem(
      db,
      actor,
      id,
      asRecord(payload) as { question: unknown; answer?: unknown; subjectType?: unknown; answerMode?: unknown; sourceKey?: unknown },
