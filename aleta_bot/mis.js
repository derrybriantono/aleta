...
const misResponseMessage = async () => {
  try {
    ...
    let promiseDataPublikasi = mis.getDataPublikasi();
    let messageDataPublikasi = await promiseDataPublikasi;
    let promiseDataVerstek = mis.getDataVerstek();
    let messageDataVerstek = await promiseDataVerstek;
    let promiseStatistikDetail = mis.getStatistikDetail();
