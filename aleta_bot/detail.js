    ...
    const message_res = async () => {
      ...
      if (data_main.data == "Tidak ada data") {
        ...
        let mix = [
          ...
          `\n*Disclaimer : Biaya proses perkara diatas adalah biaya resmi yang dipungut oleh ${pengadilan}. Tidak ada biaya lain yang dibayarkan selain biaya diatas. Apabila masih terdapat sisa dari biaya proses, mohon agar segera diambil di kasir*\n*STOP PUNGLI & GRATIFIKASI*`,
        ];
